...
(function (App) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numOfPeople) {
            const newProject = new App.Project(Math.random().toString(), title, description, numOfPeople, App.ProjectType.Active);
...
(function (App) {
    class projectList extends App.Component {
        ...
        dropHandler(event) {
            ...
            App.projectState.moveProject(projId, this.type === "active" ? App.ProjectType.Active : App.ProjectType.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector("ul");
        ...
        configure() {
            ...
            App.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((project) => {
                    if (this.type === "active") {
                        return project.status === App.ProjectType.Active;
                    }
                    return project.status === App.ProjectType.Finished;
                });
